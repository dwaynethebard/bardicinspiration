...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { delete: @type.delete, index: @type.index, new: @type.new, show: @type.show } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { delete: @type.delete, index: @type.index, new: @type.new, show: @type.show } }
